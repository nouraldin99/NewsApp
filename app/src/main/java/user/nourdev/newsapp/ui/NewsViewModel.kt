...
import user.nourdev.newsapp.NewsApplication
import user.nourdev.newsapp.models.Article
import user.nourdev.newsapp.models.NewsResponse
...
private suspend fun safeBreakingNewsCall(countryCode: String){
    ...
    private fun hasInternetConnection():Boolean{
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            val capabilities = connectActivityManager.getNetworkCapabilities(activeNetwork)
